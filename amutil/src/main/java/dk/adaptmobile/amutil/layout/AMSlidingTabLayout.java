...
public class AMSlidingTabLayout extends HorizontalScrollView {
    ...
    private final AMSlidingTabStrip mTabStrip;

    public AMSlidingTabLayout(Context context) {
        this(context, null);
    }

    public AMSlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AMSlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new AMSlidingTabStrip(context);
     ...
     * {@link AMSlidingTabLayout} you are required to set any
...
//        textView.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/" + context.getString(R.string.trade_gothic)));
