 ...
 * Follow http://stackoverflow.com/questions/16017165/auto-fit-textview-for-android
 * for more info
 */
public class AMAutoScaleTextView extends TextView {
    ...
    public AMAutoScaleTextView(final Context context)
    {
        this(context,null,0);
    }

    public AMAutoScaleTextView(final Context context, final AttributeSet attrs)
    {
        this(context,attrs,0);
    }

    public AMAutoScaleTextView(final Context context, final AttributeSet attrs, final int defStyle)
    {
