...
public class AMSlidingTabStrip extends LinearLayout {

	private static final int DEFAULT_BOTTOM_BORDER_THICKNESS_DIPS = 0;
	private static final byte DEFAULT_BOTTOM_BORDER_COLOR_ALPHA = 0x26;
	private static final int SELECTED_INDICATOR_THICKNESS_DIPS = 5;
	public static final int DEFAULT_SELECTED_INDICATOR_COLOR = 0xFFAD0009;
	...
	private AMSlidingTabLayout.TabColorizer mCustomTabColorizer;
	private final SimpleTabColorizer mDefaultTabColorizer;

	public AMSlidingTabStrip(Context context) {
		this(context, null);
	}

	public AMSlidingTabStrip(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	void setCustomTabColorizer(AMSlidingTabLayout.TabColorizer customTabColorizer) {
	...
	protected void onDraw(Canvas canvas) {
		...
		final AMSlidingTabLayout.TabColorizer tabColorizer = mCustomTabColorizer != null ? mCustomTabColorizer
				: mDefaultTabColorizer;
	...
	private static class SimpleTabColorizer implements
			AMSlidingTabLayout.TabColorizer {
